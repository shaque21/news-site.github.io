        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $query_of_auth_name = "SELECT * FROM post
                    JOIN user ON post.author = user.user_id
                    WHERE post.author = {$author_id}";

                    $result_of_auth_name = mysqli_query($connect, $query_of_auth_name) or die("Query failed : category name");
                    $row_of_auth_name = mysqli_fetch_assoc($result_of_auth_name);
                     ?>
                  <h2 class="page-heading"><?php echo $row_of_auth_name['username']; ?></h2>
                    ...
                    <?php
                      ...
                      if(mysqli_num_rows($result) > 0){
                        ...
                        if(mysqli_num_rows($result_of_auth_name) > 0){
                          $total_records = mysqli_num_rows($result_of_auth_name);
